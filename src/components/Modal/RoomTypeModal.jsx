      ...
      <div className="fixed inset-0 flex items-center justify-center z-50">
        <div className="modal bg-white p-6 rounded-lg shadow-md">
          <h2 className="text-2xl font-bold mb-4">
            {isCreating ? "Create Type Room" : "Edit Type Room"}
          </h2>
          <form>
            {renderInputField("Nama Tipe Kamar", "nama_tipe_kamar")}
            {renderInputField("Harga", "harga")}
            {renderInputField("Deskripsi", "deskripsi")}
            <div className="mb-4">
